   ...
   */
    ...
    const newSemestersTotal = semestersWeeks.map((semesterWeek) => {
        return {
            ...
            totalHours: semesters.reduce((sum, semesterData) => {
                if (semesterWeek.numberSemestr == semesterData.number)
                    return sum + semesterData.totalHours + semesterData.courceWorkHours;
                else return sum;
            }, 0),
                            ...
                            <Table>
                                <TableRow>
                                    <TableCell align="center">
                                        {semesterTotal.auditor + semesterTotal.totalHours}
                                    </TableCell>
