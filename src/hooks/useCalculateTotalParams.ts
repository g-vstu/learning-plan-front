...
export const useCalculateTotalParams = (semesters: Semester[]) => {
    ...
    const totalHours = semesters.reduce((sum, semester) => sum + semester.totalHours, 0);
    ...
    useEffect(() => {
        setTotalCourseHours({
            ...
            totalClass: totalHours + course,
        });
    }, [seminars, lectures, totalHours, practices, laboratories]);
