...
export const UPDATE_WEEKS_SEMESTERS: AsyncActionSet =
    createAsyncActionSet('UPDATE_WEEKS_SEMESTERS');
export const CREATE_WEEKS_SEMESTERS: AsyncActionSet =
    createAsyncActionSet('CREATE_WEEKS_SEMESTERS');
